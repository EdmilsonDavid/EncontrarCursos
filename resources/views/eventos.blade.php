...
<body>
	...
	<header id="header" style="position: static">
		<div class="container">
			<a href="paginaprincipal" id="logo" title="HarrisonHighSchool">Encontra o seu curso</a>
			<div class="menu-trigger"></div>
			<nav id="menu">
				<ul>
					<li><a href="home">Home</a></li>
					<li><a href="instituicoesmaisprocuradas">Instituicoes</a></li>
					<li><a href="eventos">Eventos</a></li>
 				</ul>
				<ul>
					<li><a href="cursosmaisprocurados">Cursos</a></li>
					<li><a href="explicador.co.mz">Queres Explicador?</a></li>
		...
		<div class="container">
			...
			<aside id="sidebar">
				<div class="widget clearfix calendar">
					...
					<div class="table">
						<table>
							<tr>
								...
								<th class="col-2">Terca</th>
								<th class="col-3">Quarta</th>
								<th class="col-4">Quinta</th>
								<th class="col-5">Sexta</th>
								<th class="col-6">Sabado</th>
								<th class="col-7">Domingo</th>
							</tr>
							<tr>
					...
					<div class="note">
						<p class="upcoming-note">Participar</p>
						<p class="archival-note">Interessado</p>
					</div>
				</div>
				<div class="widget list">
					<h2>Instituicoes do Evento</h2>
					<ul>
					...
					<div class="btn-holder">
						<a class="btn blue" href="#">Visualizar Mais Instituicoes</a>
					</div>
				</div>
			</aside>
			<!-- / sidebar -->
		...
		<div class="container">
			<section>
				<article class="col-1">
					<h3>Contacto</h3>
					<ul>
						<li class="address"><a href="#">Bangladesh, 220, EdsUamusse<br> Edmulsse</a></li>
						<li class="mail"><a href="#">nhaliaeugenio96@gmail.com</a></li>
						<li class="phone last"><a href="#">847771864, </a></li>
					</ul>
				</article>
				<article class="col-2">
					<h3>Bate-Papo - Temas</h3>
					<ul>
						<li><a href="#">Qual o melhor curso na sua optica</a></li>
						<li><a href="#"> Quanto tempo gostarias que durasse um curso</a></li>
						<li><a href="#"> Qual e o instituto com maior qualidade de ensino </a></li>
						<li><a href="#">Os eventos da actualidade estudantil</a></li>
						<li class="last"><a href="#">Alunos graduados e suas declaracoes </a></li>
					</ul>
				</article>
				<article class="col-3">
					<h3>SRedes Sociais</h3>
					<p>Encontre-nos nessas redes sociais abaixo citados para mais interacao com a gente</p>
					<ul>
				...
				<article class="col-4">
					<h3>Novidades</h3>
					<p>Veja aque algums sugestoes de cursos que estejam mais perto de ti</p>
					<form action="#">
						<input placeholder="Endereco de Email" type="text">
			...
			<p class="copy">Direitos reservado, Densevolvido pela Edmilson Ngamula e Edson Uamusse com a participacao do Nilo Eugenio <a href="http:/Edmulsse.com.ac.mz/" title="Designed by Nhalia Eugenio" target="_blank">Edmilson_Ngamula</a>. Direitos reservado.</p>
		</div>
		<!-- / container -->
	</footer>
	<!-- / footer -->
